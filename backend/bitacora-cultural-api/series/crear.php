...
// Creador y género: campos opcionales.
$valores = [];
...
// Progreso de temporadas y episodios.
$progreso = [];
...
foreach (
    ...
    if (
        ...
        responder(422, [
            'estado' => 'error',
            'mensaje' => "El campo {$campo} debe ser un entero positivo"
        ]);
    }
...
try {
    ...
    // Comprobar que el usuario de la sesión todavía existe.
    ...
    error_log('Error al crear la serie');

    responder(500, [
        'estado' => 'error',
        'mensaje' => 'No fue posible registrar la serie'
    ]);
}
